...
export let players = [
    { nickname: "", powerUp: "", startPosition: width + 1, playerPosition:width + 1, color: "White", lives:3, connection: ""},
    { nickname: "", powerUp: "", startPosition: (width*2)-2, playerPosition:0 , color: "Red", lives:3, connection: ""},
    { nickname: "", powerUp: "", startPosition: (width*height)-(width*2)+1, playerPosition:0, color: "Blue", lives:3, connection: ""},
    { nickname: "", powerUp: "", startPosition: (width*height)-width-2,playerPosition:0, color: "Black", lives:3, connection: ""},
];
